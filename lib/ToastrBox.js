...
var ToastrBox = function (_Component) {
  ...
  function ToastrBox(props) {
    ...
    _this._onAnimationComplite = function () {
      ...
      var onHideComplete = _item$options.onHideComplete;
      var onShowComplete = _item$options.onShowComplete;
      ...
      } else if (!_this.isHiding && onShowComplete) {
        onShowComplete();
      }
    };
  ...
  _createClass(ToastrBox, [{
    ...
    value: function componentDidMount() {
      ...
      var time = item.options.timeOut || timeOut;
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('toastr', 'animated', options.icon, type);
